...
import edu.esprit.services.SmsSender;
import edu.esprit.services.TwilioConfig;
...
public class AjouterReclamation {
    ...
    public void initialize() throws SQLException {
        ...
        engine.load("http://localhost/forclass/index.html");
    }
    ...
    public void addReclamation() {
        ...
        try{
            ...
            if(result.equals("false")){
                ...
                alert.setContentText("Please redo the captcha.");
                alert.showAndWait();
...
//            // If captcha is not verified, display an alert or handle the situation accordingly
...
//        }
        ...
        try {
            ...
            try {
                String message = "A new Reclamation was added:\n " + reclamation.getDescription()+ "\n"+ "from user" + reclamation.getUser().getNom();
